...
**Session 1**
  ...
  - Smartphone app - initial
    - Add the following to your Model directory  
      ...
      ```
      wget https://k2controls.github.io/piRover02/sprint3/week15/Bluetooth/BTCommands.py
      wget https://k2controls.github.io/piRover02/sprint3/week15/Bluetooth/BTCommandService.py
      ```
