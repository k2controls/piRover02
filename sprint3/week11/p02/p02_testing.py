...
directory. (Drive class is not required)
...
#2 Access class files and class definitions 
''' Import all sprint 2 classes int this file by creating the required 
import statements in the space below.
'''
import time
pass    #Your code goes here. Delete the pass statement and insert required code.

#3 Use class definitions imported in item 2 to create the following objects.
...
- a blue LED object
- an RGB LED object
- a servo object (used for the front servo with sensor head)
- a warner object
'''
...
'''
Write the following code snippet using objects created in Step 3 and test.
1. Move the gimbal up. Motion should be limited as discussed in class.
2. Wait for 2 seconds.
3. Move the gimbal down. Motion should be limited as discussed in class.
4. Wait for 2 seconds.
5. Move the gimbal up and to the right.
...
'''
Write the following code snippet using objects created in Step 3 and test.
1. Blink the green LED once every second. Use the class method
...
3. Adjust the dimness of the blue LED so that is is 
...
'''
Write the following code snippet using objects created in Step 3 and test.
1. Move the front servo fully to the left (counter-clockwise).
2. Wait for 4 seconds.
3. Use the update function to turn the servo to a position 
just to the left of center.
4. Wait for 4 seconds.
5. Center the front servo.
'''
pass    #Your code goes here
