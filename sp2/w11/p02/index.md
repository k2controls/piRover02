...
No Zoom class session
  ...
  - Submit the required solution as a zip file to the course link on the main page. 
  - You must zip the entire solution with functional links using valid file names.
  - Submit your zipped solution by the end of the day. The submission link will be disabled at midnight. 

#### Setup - The instructor will guide you through the following.
...
6. Submit your zip file to the course link on the main page. You must submit by the end of the day. The submission link will be disabled at midnight. 
